import psycopg2
import csv
from embedding import object_embedding  # 确保这是正确的导入
...
def process_video_and_csv(video_path, vid_id, csv_path):
    ...
    with open(csv_path, 'r') as csvfile:
        ...
        for row in reader:
            ...
            embedding = object_embedding(cropped_img).tolist()
