...
def detect_and_generate_embeddings(flag_frame, detector_model, autoencoder_model):
    ...
    for detection in detections:
        ...
        embedding = object_embedding(cropped_img)
        embeddings.append(embedding)
    return embeddings   ## array of object embeddings in one frame

if __main__:
    video="videos/How Green Roofs Can Help Cities  NPR.mp4"
    ...
    for segment in segments:
        ...
        start_embeddings = detect_and_generate_embeddings(start_frame_info, detector_model, autoencoder_model)
        
        ## embeeding of the last frame
        end_embeddings = detect_and_generate_embeddings(end_frame_info, detector_model, autoencoder_model)